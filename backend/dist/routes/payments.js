...
import { createRazorpayOrder, listPaymentsForUser, verifyStudentPayment, } from "../services/payment.service.js";
...
paymentsRouter.post("/order", requireAuth, asyncHandler(async (req, res) => {
...
paymentsRouter.post("/verify", requireAuth, asyncHandler(async (req, res) => {
...
paymentsRouter.post("/coupon/validate", asyncHandler(async (req, res) => {
...
paymentsRouter.get("/invoice/:paymentId", requireAuth, asyncHandler(async (req, res) => {
