...
aiRouter.post("/resume", requireAuth, asyncHandler(async (req, res) => {
...
aiRouter.post("/roadmap", requireAuth, asyncHandler(async (req, res) => {
...
aiRouter.get("/reports", requireAuth, asyncHandler(async (req, res) => {
