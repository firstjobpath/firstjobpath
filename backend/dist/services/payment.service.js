...
export async function createRazorpayOrder(input) {
    ...
    if (input.bookingId) {
        ...
        if (booking.studentId !== input.userId)
...
async function fulfillPayment(paymentId, razorpayPaymentId) {
    ...
    if (payment.couponId)
        await incrementCouponUse(payment.couponId);
...
export async function fulfillPaymentFromWebhook(orderId, paymentId) {
    const payment = await prisma.payment.findFirst({
...
export async function refundPaymentStructure(paymentId, adminUserId) {
